    ...
    return(
        ...
        <div className='alignRow'>
            ...
            <div className='alignColumn'>
                ...
                <h3 className='textSecondary'>Professor</h3>
...
export default ScreenTeacherProfile;